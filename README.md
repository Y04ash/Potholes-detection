This project implements a pothole detection model using YOLOv8n.pt (You Only Look Once). The model is trained on a custom dataset to detect potholes in images and annotate them accordingly.
